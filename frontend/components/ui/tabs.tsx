  ...
  return (
    <div className="relative" ref={tabsListRef}>
      <TabsPrimitive.List
        ...
        data-slot="tabs-list"
        className={cn(
          "bg-card text-muted-foreground relative inline-flex h-10 w-fit items-center justify-center rounded-lg ",
          className,
        )}
        {...props}
      />
      <div
        className="absolute rounded-md border border-transparent px-2 bg-popover shadow-sm dark:border-input h-full transition-all duration-300 ease-in-out"
