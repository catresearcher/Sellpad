            ...
            return (
              <SidebarMenuItem key={item.title}>
                ...
                >
                  <a
                    href={item.url}
                    className={`${pathname === item.url ? "text-primary!" : "hover:text-white! hover:bg-accent-foreground/5!"} gap-3 transition-all duration-100 font-semibold! `}
                  >
                    {item.icon}
            ...
            >
              <SidebarMenuItem>
                <CollapsibleTrigger asChild>
                  <SidebarMenuButton
                    className={`
                      cursor-pointer transition-all duration-100 gap-3 font-semibold!
