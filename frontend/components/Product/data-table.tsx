...
export function ProductsTable() {
  ...
  const { data, isLoading } = useProducts(shopId, pageIndex, debouncedSearch);
              ...
              <TableRow>
                <TableCell colSpan={columns.length} className="h-64">
                  <div className="flex flex-col items-center justify-center gap-1 text-center h-full">
                    <span className="icon-[material-symbols-light--package-2-outline-sharp] size-20 text-primary"></span>

                    <div className="flex flex-col gap-2">
                      <h1 className="text-3xl font-medium">No Products</h1>
